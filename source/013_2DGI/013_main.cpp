...
int main()
{
	...
	std::shared_ptr<pm2d_old::PM2DRenderer> oit_renderer = std::make_shared<pm2d_old::PM2DRenderer>(context, app.m_window->getRenderTarget());
	pm2d_old::DebugPM2D oit_debug(context, oit_renderer);
