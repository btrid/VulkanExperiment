...
void MapVoxelize::setup(std::shared_ptr<btr::Loader> loader, VoxelPipeline const * const parent)
{
...
void MapVoxelize::draw(std::shared_ptr<btr::Executer>& executer, VoxelPipeline const * const parent, vk::CommandBuffer cmd)
{
