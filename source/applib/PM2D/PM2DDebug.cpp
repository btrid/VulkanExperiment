...
//	if(0)
	{
		...
		cmd.pushConstants<InputLight>(m_pipeline_layout[PipelineLayoutPointLight].get(), vk::ShaderStageFlagBits::eCompute, 0, InputLight{ light_pos, 0.f, 1.1f, vec4(2500.f, 0.f, 2500.f, 0.f) });
		cmd.dispatch(1, 1, 1);
	}
