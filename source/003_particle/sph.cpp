// https://github.com/takagi/blog-codes/blob/master/20091101/cpp/sph.cpp éQçl
#include <vector>
#include <list>
#include <map>
#include <iostream>
...
void init(dFluid& fluid)
{
	...
	static const vec3   INIT_MIN = vec3(0.0, 15.0, -5.0);
	static const vec3   INIT_MAX = vec3(10.0, 40.0, 5.0);
