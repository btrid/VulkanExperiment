...
struct GI2DDebug
{
	...
	void executeDrawReachableMap(vk::CommandBuffer cmd, const std::shared_ptr<GI2DPathContext>& gi2d_path_context, const std::shared_ptr<RenderTarget>& render_target);
