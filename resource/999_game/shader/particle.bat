...
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=vertex	-o binary\\FloorRender.vert.spv FloorRender.vert
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=fragment	-o binary\\FloorRender.frag.spv FloorRender.frag
...
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=geometry	-o binary\\MakeTriangleLL.geom.spv MakeTriangleLL.geom
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=vertex	-o binary\\RenderBrick.vert.spv RenderBrick.vert
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=fragment	-o binary\\RenderBrick.frag.spv RenderBrick.frag

glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=compute	-o binary\\BoidSoldierEmit.comp.spv BoidSoldierEmit.comp
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=compute	-o binary\\BoidSoldierUpdate.comp.spv BoidSoldierUpdate.comp
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=compute	-o binary\\BoidBrainUpdate.comp.spv BoidBrainUpdate.comp
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=vertex	-o binary\\BoidSoldierRender.vert.spv BoidSoldierRender.vert
glslc.exe -w -I Include -I ../../btrlib/shader/include -x glsl -fshader-stage=fragment	-o binary\\BoidSoldierRender.frag.spv BoidSoldierRender.frag
