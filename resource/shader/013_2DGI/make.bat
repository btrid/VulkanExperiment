...
%exe% %include% %option% -o %output%/Radiosity_RayMarch.comp.spv Radiosity_RayMarch.3.comp
...
%exe% %include% %option% -o %output%/Radiosity_Render.geom.spv Radiosity_Render.1.geom
