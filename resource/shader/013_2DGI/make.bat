...
%exe% %include% %option% -o %output%/Radiosity_RayGenerate.comp.spv Radiosity_RayGenerate.5.comp
%exe% %include% %option% -o %output%/Radiosity_RayGenerate2.comp.spv Radiosity_RayGenerate2.comp
...
rem %exe% %include% %option% -o %output%/Radiosity_RayMarch.comp.spv Radiosity_RayMarch2.1.comp
%exe% %include% %option% -o %output%/Radiosity_SortVertex.comp.spv Radiosity_SortVertex.comp
...
rem %exe% %include% %option% -o %output%/Radiosity_RaySort.comp.spv Radiosity_RaySort.comp
