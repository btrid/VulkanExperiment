...
rem %exe% %include% %option% -o %output%/Radiosity_RayMarch.comp.spv Radiosity_RayMarch3.comp
%exe% %include% %option% -o %output%/Radiosity_RayMarch.comp.spv Radiosity_RayMarch4.comp
