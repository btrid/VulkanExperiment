...
%exe% %include% %option% -o %output%/Radiosity_RayMarch.comp.spv Radiosity_RayMarch2.2.comp
...
%exe% %include% %option% -o %output%/Radiosity_RayBounce2.comp.spv Radiosity_RayBounce2.comp
