...
rem %exe% %include% %option% %output%/Radiosity_DirectLighting.vert.spv Radiosity_DirectLighting.vert
 %exe% %include% %option% %output%/Radiosity_DirectLighting.vert.spv Radiosity_DirectLighting2.vert
%exe% %include% %option% %output%/Radiosity_DirectLighting.geom.spv Radiosity_DirectLighting.geom
